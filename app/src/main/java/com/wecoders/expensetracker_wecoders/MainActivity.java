...
public class MainActivity extends AppCompatActivity {
    ...
    private void showTodayExpense() {
        ...
        you_spent.setText("" + expense);
        you_spent.setTextColor(Color.RED);
    }
    ...
    private void showSavings() {
        ...
        previous_savings.setText("" + save_sum);
        previous_savings.setTextColor(Color.GREEN);
